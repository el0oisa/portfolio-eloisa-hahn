...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Portfólio Autoral — projetos, ideias e processo",
      },
      {
        property: "og:description",
        content:
          "Projetos de identidade visual, editorial e audiovisual, com processo e contato.",
      },
    ],
  }),
  component: Home,
  ...
  return (
    <SiteShell>
      ...
      <section className="relative overflow-hidden border-b-[length:var(--ds-border-width)] border-foreground py-ds-3xl">
        <div className="ds-container">
          <div>
            ...
            {settings?.tagline ? (
              <p className="mt-ds-lg max-w-[42rem] text-fluid-lg text-muted-foreground">
                {settings.tagline}
              </p>
            ) : null}
      ...
      <section id="projetos" className="scroll-mt-24 py-ds-2xl">
        <div className="ds-container">
          <h2 className="text-fluid-3xl uppercase">
            {copy.projectsTitle}
          </h2>

          <div
            className="mt-ds-lg flex flex-wrap gap-ds-sm"
            role="group"
          ...
          {isLoading ? (
            <p className="mt-ds-xl text-muted-foreground">
              {copy.loading}
            </p>
          ) : list.length === 0 ? (
            <p className="mt-ds-xl text-muted-foreground">
                  ...
                  <li key={p.id} className="ds-grid-offset">
                    ...
                    >
                      ...
                      <div className="flex flex-1 flex-col gap-ds-xs p-ds-lg">
                        ...
                        <h3 className="text-fluid-xl uppercase">
                          {p.title}
                        </h3>
      ...
      >
        <div className="ds-container">
          ...
          <div className="mt-ds-xl grid items-start gap-ds-xl lg:grid-cols-[280px_1fr]">
            {/* FOTO */}
            {settings?.avatar_url ? (
              <div className="ink-border hard-shadow mx-auto w-full max-w-[280px] overflow-hidden rounded-xl bg-muted lg:mx-0">
                <img
                  src={settings.avatar_url}
                  alt={`Foto de ${settings.portfolio_name ?? "perfil"}`}
            ...
            <div>
              ...
              <p className="mt-ds-md whitespace-pre-line text-muted-foreground">
                {settings?.biography}
              </p>
            </div>
          </div>

          <div className="mt-ds-xl grid gap-ds-xl lg:grid-cols-[1.2fr_1fr]">
            <div />
      ...
      <section
        id="contato"
        className="scroll-mt-24 py-ds-3xl"
      >
        <div className="ds-container">
          <h2 className="text-fluid-3xl uppercase">
            {copy.contactTitle}
          ...
          <p className="mt-ds-md max-w-[36rem] text-fluid-lg text-muted-foreground">
            {copy.contactLead}
          </p>
